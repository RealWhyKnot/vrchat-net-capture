...
2. **Describe what you tested.** This tool runs against unpredictable
   ...
   before merging.
3. **No DRM circumvention.** This tool is for inspecting traffic the
   user already legitimately receives in their VRChat session. Anything
   that decrypts, bypasses, or extracts protected content will not be
   merged.
